...
const themes: Theme[] = [
  ...
  },
  {
    name: "Coffee",
    value: "coffee",
    description: "Warm coffee shop theme",
    icon: <Sun className="h-5 w-5" />,
    preview: {
  ...
  },
  {
    name: "Winter",
    value: "winter",
    description: "Cool winter blues theme",
    icon: <Moon className="h-5 w-5" />,
    preview: {
      primary: "bg-sky-700",
  ...
  },
  {
    name: "Acid",
    value: "acid",
    description: "Vibrant acid colors theme",
    icon: <Sun className="h-5 w-5" />,
    preview: {
      primary: "bg-lime-500",
  ...
  },
  {
    name: "Lemon",
    value: "lemon",
    description: "Fresh lemon yellow theme",
    icon: <Sun className="h-5 w-5" />,
    preview: {
  ...
  },
  {
    name: "Night",
    value: "night",
    description: "Dark night sky theme",
    icon: <Moon className="h-5 w-5" />,
    preview: {
  ...
  },
  {
    name: "Bumblebee",
    value: "bumblebee",
    description: "Yellow and black theme",
    icon: <Sun className="h-5 w-5" />,
    preview: {
  ...
  },
  {
    name: "Garden",
    value: "garden",
    description: "Fresh garden theme",
    icon: <Sun className="h-5 w-5" />,
    preview: {
